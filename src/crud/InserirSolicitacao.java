...
public class InserirSolicitacao {
	...
	public static void insereSolicitacao() throws SQLException {
		...
		// comando sql a ser executado para pegar o valor da diaria do carro indicado
		// pelo usuario
		...
		// Utilizacao do Calendar para pegar a data atual e adicionar a quantidade de
		// dias que o carro ficará alugado
		...
		// Mensagem que pergunta ao usuario se deseja inserir uma nova solicitacao na
		// base de dados
